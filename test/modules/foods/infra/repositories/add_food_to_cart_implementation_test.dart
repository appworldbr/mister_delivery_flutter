...
import 'package:mister_delivery_flutter/app/modules/foods/infra/repositories/add_food_to_cart_implementation.dart';
...
main() {
  ...
  final repository = AddFoodToCartImplementation(datasource);
